package kr.gyeoul.instances.light;
...
//100% Free no license github use.
//https://github.com/aprilthepink/MinestomBasicLight
...
public class LightEngine {
    ...
    public void recalculateChunk(Chunk chunk) {
        ...
        Arrays.stream(exposed).toList().forEach(e -> Arrays.fill(e, true));
